const config = {
  ...
  collectCoverageFrom: [
    ...
    'src/views/Account/OrdersDetail/modules/cancelOrderForJp/*.{js,jsx,ts,tsx}'
  ],
  ...
  testMatch: [
    ...
    '<rootDir>/src/views/Account/OrdersDetail/modules/cancelOrderForJp/__test__/*.{js,jsx,ts,tsx}'
  ],
