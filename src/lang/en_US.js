...
const en_US = {
  ...
  'tailorednutrition.tip1': 'Health deserves to be fought for',
  'tailorednutrition.tip2': 'Our obsession with the health of pets has inspired a series of innovations for pets with serious health problems. Countless puppies, kittens, dogs and cats are living proof of the success of these formulas. Whether it\'s recovering from a medical procedure, overcoming food allergy issues, or protecting the most fragile of pets, tailor-made nutrition can help these animals reach their peak. of their health.',
  'tailorednutrition.tip3': 'What is a tailor-made diet?',
  'tailorednutrition.tip4': 'We formulate foods designed to meet unique needs with great precision. Each food provides each cat or dog with a complete and balanced complex of nutrients and amino acids that it needs to help support its muscles, keep its body healthy and strengthen its natural defenses.',
  'tailorednutrition.tip5': 'Formula example of the German Shepherd: he is particularly appreciated for his courage, his loyalty and his intelligence. However, despite his great physical and mental strength, the German Shepherd is known for its digestive sensitivity. We have therefore developed a suitable formula that contains easily assimilated proteins and specific fibers so that it is as strong on the inside as on the outside.',
  'tailorednutrition.tip6': 'Encourage their natural predispositions',
  'tailorednutrition.tip7': 'A perfectly healthy jack russell can jump to a height of six times his size. Fostering its incredible natural potential with specially selected proteins and antioxidants helps meet its specific needs.',
  'tailorednutrition.tip8': 'Unique formulas for unique needs',
