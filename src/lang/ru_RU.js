...
  'account.emailCommunication': "Связь по электронной почте",
...
  "account.preferredMmethodsOfCommunication": "Коммуникационные предпочтения",
  "account.profile": "Основная информация",
...
  "account.warmNotice": "Здесь вы можете управлять своим профилем, редактировать информацию о питомце, адрес доставки и способ оплаты, проверять статус заказов и подписок.",
...
  "cart.errorMaxCate": "В корзине не может быть более 30 товаров",
  "cart.errorMaxInfo": "Число не может быть больше 30",
...
  'download': "Скачать",
  'edit': "Редактировать",
  'editShippingAddress': "Изменить адрес доставки",
  'email': "Эл. адрес",
...
  'faq.title': 'У Вас вопрос? Посмотрите ниже, чтобы узнать, есть ли на него ответ. Если Вы не можете найти то, что ищете, нажмите здесь, чтобы связаться с нами.',
...
  'required.complete':'Завершить процесс входа в систему',
  ...
  'tailorednutrition.tip1': 'Здоровье заслуживает того, чтобы за него боролись',
  'tailorednutrition.tip2': 'Наша одержимость здоровьем домашних животных вдохновила на создание серии инноваций для домашних животных с серьезными проблемами со здоровьем. Бесчисленные щенки, котята, собаки и кошки являются живым доказательством успеха этих смесей. Будь то восстановление после медицинской процедуры, преодоление проблем с пищевой аллергией или защита самых хрупких домашних животных, индивидуальное питание может помочь этим животным достичь своего пика. своего здоровья.',
  'tailorednutrition.tip3': 'Что такое индивидуальная диета?',
  'tailorednutrition.tip4': 'Мы разрабатываем продукты, предназначенные для удовлетворения уникальных потребностей с большой точностью. Каждый корм обеспечивает каждую кошку или собаку полным и сбалансированным комплексом питательных веществ и аминокислот, необходимых для поддержки мышц, поддержания здоровья тела и укрепления естественной защиты.',
  'tailorednutrition.tip5': 'Формульный пример немецкой овчарки: его особенно ценят за мужество, верность и ум. Однако, несмотря на свои огромные физические и умственные силы, немецкая овчарка известна своей чувствительностью к пищеварению. Поэтому мы разработали подходящую формулу, которая содержит легкоусвояемые белки и специфические волокна, поэтому она настолько же сильна как внутри, так и снаружи.',
  'tailorednutrition.tip6': 'Поощряйте их естественные предрасположенности',
  'tailorednutrition.tip7': 'Совершенно здоровый Джек Рассел может прыгнуть в шесть раз больше своего роста. Усиление его невероятного природного потенциала с помощью специально подобранных белков и антиоксидантов помогает удовлетворить его особые потребности.',
  'tailorednutrition.tip8': 'Уникальные формулы для уникальных потребностей',
  'tailorednutrition.tip9': 'У многих домашних животных есть определенные челюсти и поведение, которые меняют их способ питания. Вот почему мы не только адаптируем наши рецепты на уровне питания, но также изучаем форму и текстуру каждой пищи, чтобы лучше удовлетворить физические потребности каждого животного.',
  'tailorednutrition.tip10': 'Результат',
  'tailorednutrition.tip11': 'В результате получается диета, разработанная для точного удовлетворения конкретных потребностей здоровья. Эта диета обеспечивает вашего питомца полным и сбалансированным набором питательных веществ и аминокислот, необходимых ему для наращивания сильных мышц, поддержания здоровья и укрепления иммунной системы. Дайте ему всю энергию, необходимую для процветания и максимального здоровья.',
