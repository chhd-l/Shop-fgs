const fr_FR = {
  ...
  'confirmation.info2': "Vous allez recevoir un mail de confirmation à l'adresse mail suivante {val1}",
  ...
  MMYY: 'MM / AA',
  modalCancelAllContent: 'Êtes-vous sûr(e) de vouloir supprimer cet abonnement ?',
  ...
  'productFinder.searchResultTip1ForCat': 'Voici les produits qui correspondent le mieux aux besoins de votre chat.',
  'productFinder.searchResultTip1ForDog': 'Voici les produits qui correspondent le mieux aux besoins de votre chien.',
  ...
  'qualitySafety.description': 'Au cours des cinquante dernières décennies, Royal Canin a placé la qualité nutritionnelle et la sécurité des produits au cœur de nos activités dans le monde entier. Cette attention aux moindres détails nous aide à fournir la nutrition de santé la plus précise et la plus efficace pour les animaux de compagnie.',
  ...
  'recommendation.fourContent': "Nous mettons toute notre attention au service des besoins uniques des chats et des chiens. C'est cette obsession du détail qui nous permet de proposer une alimentation précise et adaptée afin d'aider les animaux de compagnie à être au meilleur de leur forme.",
  ...
  //go back to product
  'smartFeederSubscription.backToProductTitle': 'Faites livrer vos recharges de croquettes automatiquement, sélectionnez simplement la fréquence de livraison souhaitée et ajoutez-les au panier',
  //Finalise your order
  ...
  //Easy Maintenance
  'smartFeederSubscription.dispenser1Des': "Un anneau d'étanchéité en silicone souple de qualité alimentaire et une boîte déshydratante garantissent que la nourriture de votre animal reste fraîche.",
  ...
  'smartFeederSubscription.dispenser2Des': 'Votre mangeoire ne restera jamais coincé en distribuant des aliments grâce à un système auto-adaptatif.',
  ...
  'smartFeederSubscription.dispenser3Des': 'Détachez et fixez facilement la machine pour la nettoyer avec un chiffon humide.',
  //Dispensing Mechanism
  'smartFeederSubscription.dispenser3Title': 'Entretien facile',
  //Control the Petkit Dispenser Remotely from your Phone
  'smartFeederSubscription.dispenserWithPhoneDes': "Avec la technologie de contrôle des applications, vous pouvez définir des heures d'alimentation pour nourrir automatiquement votre animal ou choisir de le nourrir manuellement. Téléchargez simplement l'application, ajoutez votre appareil et le tour est joué!",
  //how the Smart Feeder Subscription works?
  'smartFeederSubscription.dispenserWithPhoneTitle': 'Contrôlez le distributeur Petkit à distance depuis votre téléphone',
  //Receive the PetKit Dispenser for just 1.50 € more/refill compared to our standard Autoship price
  'smartFeederSubscription.feederDes': "{val}est un distributeur automatique conçu pour que votre animal reçoive la bonne quantité de nourriture au bon moment, même lorsque vous n'êtes pas à la maison.",
  //Select your product
  'smartFeederSubscription.finaliseYourOrder': 'Finalisez votre commande',
  //choose product
  'smartFeederSubscription.helpSubTitle': "Nous sommes prêts à vous aider pour toute autre question que vous pourriez avoir à propos de l'abonnement Smart Feeder.",
  ...
  'smartFeederSubscription.stepDes1': 'Grâce au distributeur PetKit, votre animal recevra toujours la bonne quantité de nourriture au bon moment',
  //Free automatic delivery
  'smartFeederSubscription.stepDes2': 'Simplifiez-vous la vie avec la livraison automatique gratuite à votre porte',
  //PetKit Dispenser for 1.50 € more/refill
  'smartFeederSubscription.stepDes3': 'Recevez le distributeur PetKit pour seulement 1,50 € de plus / recharge par rapport à notre prix standard de livraison automatique',
  ...
  'smartFeederSubscription.stepTitl3': 'Distributeur PetKit pour 1,50 € de plus / recharge',
  'smartFeederSubscription.tabDes1': 'Avec expédition automatique à votre porte',
  ...
  'smartFeederSubscription.titleHow': "comment fonctionne l'abonnement Smart Feeder?",
  //Choose your product
  'smartFeederSubscription.titleWhy': "Pourquoi choisir l'abonnement Smart Feeder?",
  ...
  "onlineStore.header.title": "Royal Canin Online Store",
  ...
  "onlineStore.footer.title": "Any question",
  "onlineStore.footer.content": "Need some help ? {val1} our team is available to answer all your questions and ensure the best possible shopping experience.{val1} Feel free to reach us through the following options:",
  "onlineStore.BottomInfo.phone.title": "By phone",
  "onlineStore.BottomInfo.phone.content1": "0845 300 5011",
  "onlineStore.BottomInfo.phone.content2": "De 8h30 à 12h30 et de 14h à 17h du lundi au vendredi {val1} (appel non surtaxé)",
  "onlineStore.BottomInfo.email.title": "By e-mail",
  "onlineStore.BottomInfo.email.content1": "Nous vous répondons sous deux jours ouvrés.",
  "onlineStore.BottomInfo.email.content2": "Send e-mail",
  "onlineStore.BottomInfo.faq.title": "Any questions?",
  ...
  "onlineStore.BottomInfo.faq.content2": "See FAQ",
}
