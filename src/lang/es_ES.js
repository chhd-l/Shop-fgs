const en_US = {
  ...
  // 产品分类
  'product.catogery1.desc': 'Dietas de mantenimiento que ayudan a mantener la salud de los perros en cada etapa de su vida.',
  'product.catogery1.name': 'Prescription dogs',
  'product.catogery1.title': 'Dietas de prescripción veterinaria para perros',
  'product.catogery2.desc': 'Dietas de mantenimiento que ayudan a mantener la salud de los gatos en cada etapa de su vida.',
