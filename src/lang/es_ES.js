const es_ES = {
  ...
  'productFinder.searchResultTip1ForCat': "A continuación se muestran los productos que mejor se adaptan a las necesidades de su gato.",
  'productFinder.searchResultTip1ForDog': "A continuación se muestran los productos que mejor se adaptan a las necesidades de su perro.",
  ...
  'registerCompleteForm': 'Para crear su cuenta, complete el formulario a continuación.',
  'registerHaveAccount': '¿Ya tienes una cuenta?',
  'registerLoginIn': 'Iniciar sesión',
  'registerContinuing': 'Al continuar, acepta nuestra política de privacidad de MARS. recopilará y utilizará su nombre, apellido y dirección de correo electrónico para brindarle una experiencia personalizada. ',
  'registerOr': 'O',
  ...
  'registerFooter1': 'Debe tener 16 años o más para enviar un formulario. Puede ponerse en contacto con nosotros escribiendo a Royal Canin France, Consumer Service - BP4 - 650 avenue de la Petite Camargue - 30470 AIMARGUES o por correo electrónico a ',
