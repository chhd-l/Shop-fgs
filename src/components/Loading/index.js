  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {/* <div className="rcSpinner rc-loader-infinite spinner" data-js-progress="">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 190.7 104" className="rc-loader__logo" style={{position: (this.props.positionFixed?'fixed':'')}} data-js-import-interactive-svg="null" svg-animate-processed="true">
