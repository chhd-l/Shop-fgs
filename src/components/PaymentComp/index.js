...
class PaymentComp extends React.Component {
  ...
  async getPaymentMethodList() {
    ...
    try {
      ...
      if (
        confirmCardInfo.id &&
        tmpList.filter((el) => confirmCardInfo.id === el.id).length
      ) {
  ...
  handleClickEdit = (e, el) => {
    ...
    creditCardInfoForm.cardMmyy = creditCardInfoForm.paymentMethod
      ? creditCardInfoForm.paymentMethod.expiration_date.substr(0, 3) +
        creditCardInfoForm.paymentMethod.expiration_date.substr(5)
      : '';
    ...
    this.setState(
      {
        isEdit: true,
        creditCardInfoForm,
        currentEditOriginCardInfo: Object.assign({}, creditCardInfoForm)
      },
      () => {
        this.scrollToPaymentComp();
      }
            ...
            >
              ...
              {this.props.canEdit && (
                <span
                  ...
                  onClick={(e) => this.handleClickEdit(e, el)}
                >
                ...
                <div className="row ui-margin-top-1-md-down PayCardBoxMargin">
                  <div className="col-md-4 col-6 color-999">
                    ...
                    <span className="creditCompleteInfo fontFitSCreen">
                      xxxx xxxx xxxx{' '}
                      {el.paymentMethod ? el.paymentMethod.last_4_digits : ''}
                    </span>
                  </div>
              ...
              >
                <div className="row ui-margin-top-1-md-down">
                  <div className="col-12 color-999">
                    ...
                    <br />
                    <span className="creditCompleteInfo">
                      {el.paymentMethod && el.paymentMethod.holder_name}
                    </span>
                  </div>
                </div>
                <div className="row ui-margin-top-1-md-down">
  ...
  render() {
    ...
    return (
      <div
        ...
        id="PaymentComp"
        className={`loginCardBox ${this.isLogin ? '' : 'hidden'}`}
      >
