...
class MapFlag extends React.Component {
  ...
  render(h) {
    return(
      <div>
        <div data-tooltip-placement="top" data-tooltip={this.props.obj.title+this.props.obj.id} className="rc-margin-top--md rc-text--center">
      ...
      <div id={this.props.obj.title+this.props.obj.id} className="gm-style-iw-c" 
      style={{ display: this.state.show === true? "block":"none"}}>
        <div className="rc-tooltip rc-text--left rc-padding--xs" id="map-tooltip" style={{ display:'block'}}>
          <div className="rc-margin-bottom--md--mobile rc-margin-bottom--sm--desktop" style={{marginBottom:"0"}}>
            <h1 className="rc-card__title rc-delta">{this.props.obj.title}</h1>
            <p>{this.props.obj.phone} </p>
            <p style={{display: "inline-block",width:"10rem"}}>{this.props.obj.desc}</p>
