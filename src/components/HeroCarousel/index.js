            ...
            <div className="d-flex align-items-center hero-carousel__slide__inner flex-column-reverse flex-column flex-md-row">
              ...
              <div className="hero-carousel__slide__content">
                <div className="rc-gamma inherit-fontsize">
                  <h1>Maintain your pet's health with proper nutrition</h1>
                </div>
            ...
            <div className="d-md-flex align-items-center hero-carousel__slide__inner">
              <div className="hero-carousel__slide__list d-xl-flex align-items-center">
                <ul className="rc-list rc-list--blank rc-list--align rc-list--large-icon">
                  <li className="rc-list__item"><i className="icon-paw rc-margin-right--xs"></i>Pet Nutrition</li>
                  <li className="rc-list__item"><i className="icon-paw rc-margin-right--xs"></i>Personal consultant</li>
                  <li className="rc-list__item"><i className="icon-paw rc-margin-right--xs"></i>FREE veterinary examinations</li>
                  <li className="rc-list__item"><i className="icon-paw rc-margin-right--xs"></i>Branded accessories and VIP service</li>
                </ul>
              </div>
              <div className="hero-carousel__slide__img" style={{ background: 'url(https://www.shop.royal-canin.ru/dw/image/v2/BCMK_PRD/on/demandware.static/-/Library-Sites-RoyalCaninSharedLibrary/default/dw8b44df00/homepage/clubvisuel@2x.jpg?sw=1020&amp;sfrm=png)' }}>
                <picture>
                  ...
                  <img src="https://www.shop.royal-canin.ru/dw/image/v2/BCMK_PRD/on/demandware.static/-/Library-Sites-RoyalCaninSharedLibrary/default/dw8b44df00/homepage/clubvisuel@2x.jpg?sw=1020&amp;sfrm=png" alt="ROYAL CANIN® CLUB for kittens" title="ROYAL CANIN® CLUB for kittens" />
                </picture>
              </div>
            ...
            <div className="d-md-flex align-items-center hero-carousel__slide__inner">
              <div className="hero-carousel__slide__img" style={{ background: 'url(https://www.shop.royal-canin.ru/dw/image/v2/BCMK_PRD/on/demandware.static/-/Library-Sites-RoyalCaninSharedLibrary/default/dw2e497bea/homepage/slider-img-help.jpg?sw=1020&amp;sfrm=png)' }}>
                <picture>
                  ...
                  <img src="https://www.shop.royal-canin.ru/dw/image/v2/BCMK_PRD/on/demandware.static/-/Library-Sites-RoyalCaninSharedLibrary/default/dw2e497bea/homepage/slider-img-help.jpg?sw=1020&amp;sfrm=png" alt="Personal Consultant ROYAL CANIN® CLUB" title="Personal Consultant ROYAL CANIN® CLUB" />
                </picture>
              </div>
              <div className="hero-carousel__slide__text text-center d-md-flex align-items-center">
                <div className="hero-carousel__slide__text__inner rc-padding-x--lg--mobile">
                  <div className="rc-delta inherit-fontsize children-nomargin">
                    <h2>Our experts will do everything to help you!</h2>
                  </div>
