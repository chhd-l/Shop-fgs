        ...
        <div className="rc-layout-container rc-one-column">
          <div className="rc-column rc-padding-x--xs--desktop rc-padding-x--none--mobile">
            <nav data-toggle-group="mobile" data-toggle-effect="rc-expand--vertical" className="rc-padding-x--xs--desktop rc-padding-x--none--mobile">
              <ul className="rc-list rc-list--blank rc-list--align rc-list--inverse d-flex justify-content-between" role="menubar">
                <li className="rc-list__item rc-list__item--group">
                  <button className="rc-list__header border-0" id="footer-head-158504765613564650" data-toggle="footer-list-158504765613564650" role="menuitem">
                  ...
                  <ul className="list list--blank list--align" id="footer-list-158504765613564650" aria-labelledby="footer-head-158504765613564650" role="menu">
                    <li className="rc-list__item">
                      <a className="rc-list__link text-decoration-none border-0 color-f6f6f6" href="https://www.royalcanin.com/mx/about-us" role="menuitem">
                        <FormattedMessage id="aboutUs2" />
                      </a>
                    </li>
                    <li className="rc-list__item">
                      <a className="rc-list__link text-decoration-none border-0 color-f6f6f6" href="https://www.royalcanin.com/mx/about-us/our-values" role="menuitem">
                        <FormattedMessage id="footer.ourValues" />
                      </a>
                    </li>
                    <li className="rc-list__item">
                      <a className="rc-list__link text-decoration-none border-0 color-f6f6f6" href="https://www.royalcanin.com/mx/about-us/quality-and-food-safety" role="menuitem">
                        <FormattedMessage id="footer.qualityAndSafety" />
                      </a>
                    </li>
                    <li className="rc-list__item">
                      <a className="rc-list__link text-decoration-none border-0 color-f6f6f6" href="https://www.royalcanin.com/mx/cats/health-and-wellbeing" role="menuitem">
                ...
                <li className="rc-list__item rc-list__item--group">
                  <button className="rc-list__header border-0" id="footer-head-158504765613561849" data-toggle="footer-list-158504765613561849" role="menuitem">
                    <h3 className="rc-padding-left--md--mobile">
                  ...
                  <ul className="list list--blank list--align" id="footer-list-158504765613561849" aria-labelledby="footer-head-158504765613561849" role="menu">
                    <li className="rc-list__item">
                      <Link className="rc-list__link text-decoration-none border-0 color-f6f6f6" to="/list/cats" role="menuitem">
                        <FormattedMessage id="cats" />
                      </Link>
                    </li>
                    <li className="rc-list__item">
                      <Link className="rc-list__link text-decoration-none border-0 color-f6f6f6" to="/list/dogs" role="menuitem">
                ...
                <li className="rc-list__item rc-list__item--group">
                  <button className="rc-list__header border-0" id="footer-head-158504765613551093" data-toggle="footer-list-158504765613551093" role="menuitem">
                    <h3 className="rc-padding-left--md--mobile">
                  ...
                  <ul className="list list--blank list--align" id="footer-list-158504765613551093" aria-labelledby="footer-head-158504765613551093" role="menu">
                    <li className="rc-list__item">
                      <Link className="rc-list__link text-decoration-none border-0 color-f6f6f6" to="/help" role="menuitem">
                        <FormattedMessage id="footer.contacts" />
                      </Link>
                    </li>
                    <li className="rc-list__item">
                      <Link className="rc-list__link text-decoration-none border-0 color-f6f6f6" to="/FAQ" role="menuitem">
                ...
                <li className="rc-list__item rc-list__item--group">
                  <button className="rc-list__header border-0 border-0" id="footer-head-158504765613549553" data-toggle="footer-list-158504765613549553" role="menuitem">
                    <h3 className="rc-padding-left--md--mobile">
                  ...
                  <ul className="list list--blank list--align" id="footer-list-158504765613549553" aria-labelledby="footer-head-158504765613549553" role="menu">
                    <li className="rc-list__item">
                      <Link className="rc-list__link text-decoration-none border-0 color-f6f6f6" to="/privacypolicy" role="menuitem">
                        <FormattedMessage id="footer.privacyPolicy" />
                      </Link>
                    </li>
                    <li className="rc-list__item">
                      <a className="rc-list__link text-decoration-none border-0 color-f6f6f6" href="https://www.mars.com/global/policies/note-to-parents/np-russian" role="menuitem">
                        <FormattedMessage id="footer.informationForParents" />
                      </a>
                    </li>
                    <li className="rc-list__item">
                      <Link className="rc-list__link text-decoration-none border-0 color-f6f6f6" to="/termuse" role="menuitem">
                        <FormattedMessage id="footer.websiteTermsOfUse" />
                      </Link>
                    </li>
                    <li className="rc-list__item">
                      <a className="rc-list__link text-decoration-none border-0 color-f6f6f6" href="https://www.mars.com/cookies-spain" role="menuitem">
                        <FormattedMessage id="footer.cookieCollectionPolicy" />
                      </a>
                    </li>
                  </ul>
                </li>
                <li className="rc-list__item rc-list__item--group"></li>
              </ul>
            </nav>
