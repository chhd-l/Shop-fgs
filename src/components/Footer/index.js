            ...
            <div className="rc-column rc-padding-x--xs--desktop rc-padding-x--none--mobile">
              <nav data-toggle-group="mobile" data-toggle-effect="rc-expand--vertical" className="rc-padding-x--xs--desktop rc-padding-x--none--mobile">
                <ul className="rc-list rc-list--blank rc-list--align rc-list--inverse d-flex justify-content-between flex-wrap flex-md-nowrap" role="menubar">
                  {
                    this.state.cur_menubar.map(item=>item.map(item=>{
                      return (
                              ...
                              item.list.map(listItem=>{
                                return (
                                  <li className="rc-list__item">
                                    {!!listItem.link?
                                    <Link className="rc-list__link text-decoration-none color-f6f6f6" to={listItem.link} role="menuitem">
                                      <FormattedMessage id={listItem.messageId} />
                                    </Link>:
                                    <a className="rc-list__link text-decoration-none color-f6f6f6" href={(!!listItem.prop)&&this.props.configStore[listItem.prop]||listItem.url} role="menuitem">
                                      <FormattedMessage id={listItem.messageId} />
                                    </a>}                               
                                  </li>
                                )
