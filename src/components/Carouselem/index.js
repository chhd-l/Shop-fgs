      ...
      >
        <div className="rc-carousel__card-gal">
          {list.map((item, index) => {
            return (
              <article
                className="rc-card rc-card--b tns-item tns-slide-active"
                key={index}
              >
                <Link
                  to={`${item.linkUrl}${sourceParam ? sourceParam : ''}`}
                    ...
                    <div className="row h-100">
                      <picture className="mx-auto col-4 col-sm-3 col-md-12 rc-margin-bottom--xs--desktop">
                        <img
                          ...
                          src={item.imgUrl1 || item.imageUrl}
                          alt="alt text"
                        />
                      </picture>
                      <div className="text-left text-md-center col-8 col-sm-9 col-md-12 d-flex flex-column rc-padding-left--none--mobile align-self-center align-self-md-start">
                        <header>
                          <h3 className="rc-card__title rc-gamma rc-margin--none--mobile rc-margin-bottom--none--desktop">
                            {item.title}
                          </h3>
                        </header>
