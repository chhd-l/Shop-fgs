...
export default function FullScreenModal(props) {
  const id = props.id || 'full-modal-a';
  return (
    <aside
      role="modal"
        ...
        <section class="rc-modal__content rc-scroll--y h-100 rc-padding-top--lg--desktop ">
          <div class="rc-margin-top--none">
            <div class="rc-padding--sm rc-margin-bottom--sm  rc-agreements-container">
              ...
              <br />
              <p>
                Ünvan ROYAL CANIN TURKEY EVCİL HAYVAN ÜRÜNLERİ TİCARET LTD.ŞTİ.
              </p>
              <p>
              ...
              <div class="content-asset">
                ...
                <p id="anchor1">
                  ...
                  kullanmasından itibaren 10 (on) gün içinde ilgili ürünü
                  Satıcı’ya kutusu, ambalajı, varsa standart aksesuarları ve
                  varsa ürün ile birlikte hediye edilen diğer ürünler ile
                  birlikte eksiksiz ve hasarsız olarak iade etmesi
                  gerekmektedir. Alıcı, iade edeceği ürünü, kendisine teslimat
                  yapan kargo şirketi aracılığıyla gönderim ücreti Satıcı’ya ait
                  olmak üzere Satıcı’ya geri gönderebilir. Cayma hakkının
                  kullanılmasını takip eden 14 (ondört) gün içinde iade edilen
                  ürünün bedeli, Alıcı’nın ödeme şekli kullanılarak iade edilir.
                  Ürün iade edilirken, ürünün teslimi sırasında Alıcı’ya ibraz
                  edilmiş olan fatura aslının da Alıcı tarafından iade edilmesi
                  gerekmektedir.
                </p>
                ...
                <p>
                  ...
                  karışan ve doğası gereği ayrıştırılması mümkün olmayan mallara
                  ilişkin sözleşmeler.
                </p>
                <p>
                ...
                <p>
                  ...
                  Korunması Hakkında Kanun’un 68/1. maddesinde belirtilen alt ve
                  üst limitler doğrultusunda tüketici talepleri hakkında ilçe/il
