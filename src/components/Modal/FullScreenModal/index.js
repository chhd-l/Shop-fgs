  ...
  render() {
    return (
      <aside
        ...
        data-modal-target="standard-sales-agreement"
        data-rc-feature-modal-setup="true"
        data-rc-modal-active="true"
      >
        <div class="rc-modal__container h-100">
          <header class="rc-modal__header">
            <button
              class="rc-btn rc-icon rc-btn--icon-label rc-modal__close rc-close--xs rc-iconography"
              data-modal-trigger="standard-sales-agreement"
            ></button>
          </header>
          <section class="rc-modal__content rc-scroll--y h-100 rc-padding-top--lg--desktop ">
            <div class="rc-margin-top--none">
              <div class="rc-padding--sm rc-margin-bottom--sm  rc-agreements-container">
                ...
                <p>
                  Adres ESENTEPE MAH. BÜYÜKDERE CAD. ASTORIA KULELERİ NO:127 A
                  BLOK KAT:1 ŞİŞLİ İSTANBUL
                </p>
                    ...
                    >
                      ...
                      <tbody class="rc-table__tbody">
                        <tr class="rc-table__row">
                          ...
                          <td class="rc-table__td">55.00 TL</td>
                ...
                <div class="content-asset">
                  ...
                  <p>
                    ...
                    hakkına sahiptir. Ayrıca Alıcı, Sözleşme’nin kurulmasından
                    ürünün teslimine kadar olan süre içinde de cayma hakkını
                    kullanabilir.
                  </p>
                  <p id="anchor1">
                    Alıcı’nın <a href="#test2">cayma</a> hakkını kullandığına
                    dair bildirimin, e-posta adresine gönderilecek bir bildirim
                    ile Satıcı’ya iletmiş olması gerekir. Alıcı’nın cayma
                    hakkını kullanmasından itibaren 10 (on) gün içinde ilgili
                    ürünü Satıcı’ya kutusu, ambalajı, varsa standart
                    aksesuarları ve varsa ürün ile birlikte hediye edilen diğer
                    ürünler ile birlikte eksiksiz ve hasarsız olarak iade etmesi
                    gerekmektedir. Alıcı, iade edeceği ürünü, kendisine teslimat
                    yapan kargo şirketi aracılığıyla gönderim ücreti Satıcı’ya
                    ait olmak üzere Satıcı’ya geri gönderebilir. Cayma hakkının
                    kullanılmasını takip eden 14 (ondört) gün içinde iade edilen
                    ürünün bedeli, Alıcı’nın ödeme şekli kullanılarak iade
                    edilir. Ürün iade edilirken, ürünün teslimi sırasında
                    Alıcı’ya ibraz edilmiş olan fatura aslının da Alıcı
                  ...
                  <p>
                    ...
                    ihtiyaçları doğrultusunda hazırlanan mallara ilişkin
                    sözleşmeler.
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>d.</strong>&nbsp;Tesliminden sonra ambalaj, bant,
                    mühür, paket gibi koruyucu unsurları açılmış olan mallardan;
                    iadesi sağlık ve hijyen açısından uygun olmayanların
                    teslimine ilişkin sözleşmeler.
                  </p>
                  <p>
                    <strong>e.</strong>&nbsp;Tesliminden sonra başka ürünlerle
                    karışan ve doğası gereği ayrıştırılması mümkün olmayan
                    mallara ilişkin sözleşmeler.
                  </p>
                  <p>
                    <strong>f.</strong>&nbsp;Malın tesliminden sonra ambalaj,
                    bant, mühür, paket gibi koruyucu unsurları açılmış olması
                    halinde maddi ortamda sunulan kitap, dijital içerik ve
                  ...
                  <p>
                    Sözleşme’nin uygulanmasında, Gümrük ve Ticaret Bakanlığınca
                    ilan edilen değere kadar, Alıcı’nın ürünü satın aldığı ve
                    ikametgâhının bulunduğu yerdeki Tüketici Hakem Heyetleri ile
                    Tüketici Mahkemeleri yetkilidir. 6502 Sayılı Tüketicinin
                    Korunması Hakkında Kanun’un 68/1. maddesinde belirtilen alt
                    ve üst limitler doğrultusunda tüketici talepleri hakkında
                    ilçe/il tüketici hakem heyetleri yetkilidir.
                  </p>
                  <p>
                    İşbu Mesafeli Satış Ön Bilgilendirme Formu’nun Alıcı
                    tarafından okunup onaylanmasının ardından Satıcı ile Alıcı
                    arasında Mesafeli Satış Sözleşmesi’nin kurulması aşamasına
                    geçilecektir.
                  </p>
                </div>
              </div>
