...
class PasswordInput extends React.Component {
  ...
  validInput = (value) => {
    ...
    const valid = ruleLength && ruleLower && ruleUpper && ruleAname && ruleSpecial;
      ...
      <Input
        ...
        rightOperateBoxJSX={
          <>
            {!passwordValue ? null : (
              <span
                className={'iconfont iconchahao font-bold icon-unsuscribe cursor-pointer inline-block py-3 px-2'}
                style={{ color: '#c03344' }}
