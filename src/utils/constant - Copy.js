...
export const DELIVER_STATUS_ENUM = {
  NOT_YET_SHIPPED: CURRENT_LANGFILE&&CURRENT_LANGFILE['deliveryStatus.NOT_YET_SHIPPED'],
  SHIPPED: CURRENT_LANGFILE&&CURRENT_LANGFILE['deliveryStatus.SHIPPED'],
  PART_SHIPPED: CURRENT_LANGFILE&&CURRENT_LANGFILE['deliveryStatus.PART_SHIPPED'],
  VOID: CURRENT_LANGFILE&&CURRENT_LANGFILE['deliveryStatus.VOID']
};
export const ORDER_STATUS_ENUM = {
  INIT: CURRENT_LANGFILE&&CURRENT_LANGFILE['orderStatus.INIT'],
  REMEDY: CURRENT_LANGFILE&&CURRENT_LANGFILE['orderStatus.REMEDY'],
  REFUND: CURRENT_LANGFILE&&CURRENT_LANGFILE['orderStatus.REFUND'],
  AUDIT: CURRENT_LANGFILE&&CURRENT_LANGFILE['orderStatus.AUDIT'],
  DELIVERED_PART: CURRENT_LANGFILE&&CURRENT_LANGFILE['orderStatus.DELIVERED_PART'],
  DELIVERED: CURRENT_LANGFILE&&CURRENT_LANGFILE['orderStatus.DELIVERED'],
  CONFIRMED: CURRENT_LANGFILE&&CURRENT_LANGFILE['orderStatus.CONFIRMED'],
  COMPLETED: CURRENT_LANGFILE&&CURRENT_LANGFILE['orderStatus.COMPLETED'],
  VOID: CURRENT_LANGFILE&&CURRENT_LANGFILE['orderStatus.VOID']
};
export const PAY_STATUS_ENUM = {
  REFUND: CURRENT_LANGFILE&&CURRENT_LANGFILE['payStatus.REFUND'],
  NOT_PAID: CURRENT_LANGFILE&&CURRENT_LANGFILE['payStatus.NOT_PAID'],
  PAID: CURRENT_LANGFILE&&CURRENT_LANGFILE['payStatus.PAID'],
  PAYING: CURRENT_LANGFILE&&CURRENT_LANGFILE['payStatus.PAID_IN']
};
...
export const ADDRESS_RULE = [
  {
    key: 'firstName',
    require: true,
    errMsg: CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.errorInfo'].replace(
      /{.+}/,
      CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.firstName']
    )
  },
  {
    key: 'lastName',
    ...
    errMsg: CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.errorInfo'].replace(
      /{.+}/,
      CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.lastName']
    )
  },
  {
    key: 'address1',
    ...
    errMsg: CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.errorInfo'].replace(
      /{.+}/,
      CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.address1']
    )
  },
  {
    key: 'country',
    ...
    errMsg: CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.errorInfo'].replace(
      /{.+}/,
      CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.country']
    )
  },
  {
    key: 'city',
    ...
    errMsg: CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.errorInfo'].replace(
      /{.+}/,
      CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.city']
    )
  },
  // {
  //   key: 'email',
  ...
  // },
  {
    ...
    errMsg: CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.errorInfo'].replace(
      /{.+}/,
      CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.phoneNumber']
    )
  },
  {
    key: 'postCode',
...
export const PAYMENT_METHOD_RULE = [
  ...
  },
  {
    ...
    errMsg: CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.errorInfo'].replace(
      /{.+}/,
      CURRENT_LANGFILE&&CURRENT_LANGFILE['payment.cardOwner']
    )
  },
  {
    key: 'email',
