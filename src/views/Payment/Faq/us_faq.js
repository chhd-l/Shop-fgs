                ...
                <dl data-toggle-group="" data-toggle-effect="rc-expand--vertical" className="rc_faq_list">
                    ...
                    <div className="rc-list__accordion-item" onClick={() => this.faqItemClick(3)}>
                        ...
                        <dd className="rc-list__content" id="content-530" aria-labelledby="heading-530">
                            <p style={{ padding: '0 1.5rem 1rem 0.5rem' }}>Please see our return policy in our
                              <Link to="/termsandconditions" >  <span style={{ color: '#6888c9' }}>Terms and Conditions</span> </Link>
                            &nbsp;or <Link to="/help/contact" target="_blank" ><span style={{ color: '#6888c9' }}>contact us</span></Link> for further assistance.</p>
                        </dd>
                    </div>
                </dl>
            </Fragment>
