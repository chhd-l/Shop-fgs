            ...
            <Fragment>
                ...
                <dl data-toggle-group="" data-toggle-effect="rc-expand--vertical" className="">
                    <div className="rc-list__accordion-item">
                        <dt>
                            <button className="rc-list__header" id="heading-73" data-toggle="content-73" data-js-open="true" style={{background:'#f6f6f6'}}><p style={{width:'280px'}}>Comment puis-je joindre le service client ?</p></button>
                        </dt>
