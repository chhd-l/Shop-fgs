                        ...
                        <div className=" col-12 col-lg-6">
                          <div className="text-center text-lg-left rc-padding-y--sm rc-padding-y--md--mobile">
                            ...
                            <p>
                              ...
                              Elegimos los ingredientes en función de su alto
                              valor nutricional y beneficios para la salud
                              animal. Por ejemplo, solo usamos carne y pescado
                              de la cadena alimentaria humana. Royal Canin hace
                              todo lo posible para obtener materias primas de
                              proveedores aprobados cerca de los centros de
                              producción, lo que apoya la economía local,
                              garantiza la frescura del producto y reduce la
                              huella de carbono.
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="experience-component experience-assets-textContent">
                    <div className="rc-max-width--xl rc-padding-x--sm rc-padding-x--md--mobile rc-margin-y--sm rc-margin-y--lg--mobile richtext text-center ">
                      ...
                      <p>
                        ...
                        Aplicamos rigurosos criterios de selección para
                        seleccionar proveedores que puedan ayudarnos a mantener
                        los más altos estándares de calidad y seguridad en la
                        industria. Como parte de esto, realizamos auditorías
                        profundas para determinar el valor nutricional, la
                        calidad de la producción, la trazabilidad y los
                  ...
                  <div className="experience-component experience-assets-textContent">
                    <div className="rc-max-width--xl rc-padding-x--sm rc-padding-x--md--mobile rc-margin-y--sm rc-margin-y--lg--mobile richtext text-center ">
                      ...
                      <p>
                        ...
                        Se analiza el 100% de las materias primas utilizadas y
                        se guarda una muestra de cada una de ellas durante dos
                        años. Así podemos rastrear de un extremo a otro de la
                        cadena, cada materia prima a lo largo del período de
