                ...
                <div className="row rc-margin-x--none">
                    <div className="rc-full-width">
                        <div className="experience-component experience-assets-headingBlock">
                            <div className="rc-max-width--md text-center rc-margin-y--md" style={{ marginBottom: 0 }}>
                                <div className="rc-alpha inherit-fontsize">
                                    <h1><FormattedMessage id="onlineStore.header.title" /></h1>
                                </div>
                                <div
                                    className="text-center rc-intro inherit-fontsize children-nomargin heading-block-content">
                                    <p><FormattedMessage id="onlineStore.header.content" /></p>
                                </div>
                            </div>
                        </div>
                    </div>
