            ...
            <div className="rc-bg-colour--brand3">
              <div className="rc-padding-left--none">
                <div className="rc-padding--sm rc-padding-left--none">
                  ...
                  <p>
                    <h6 style={{fontWeight:'550'}}>ROYAL CANIN SALES TERMS AND CONDITIONS</h6>
                  </p>
                  <p>
                    Welcome to ROYAL CANIN!
                    <br/>
                    <br/>
                    ROYAL CANIN U.S.A., Inc. (<a style={{fontWeight:'550'}}>“ROYAL CANIN,” “we,” “us,” “our”</a>) provides its ROYAL CANIN-branded products and related services (collectively, our <a style={{fontWeight:'550'}}>“Products”</a>) to you as our valued customer (<a style={{fontWeight:'550'}}>“Customer”, “you”, “yours”</a>) through our website located at <a href={'https://shop.royalcanin.com'} style={{textDecoration:'underline'}}>https://shop.royalcanin.com</a> and all related domains, subdomains, software, services, and features (collectively, the <a style={{fontWeight:'550'}}>“Site”</a>). ROYAL CANIN makes this Site available for your use subject to the Terms and Conditions contained herein (as amended from time to time, the <a style={{fontWeight:'550'}}>“Terms”</a>) and the ROYAL CANIN Terms of Use, available here <a style={{textDecoration:'underline'}} href={'https://www.mars.com/legal'}>https://www.mars.com/legal</a>.
                    <br />
                    <br />
                  ...
                  <p>
                    <a style={{fontWeight:'550'}}>5. PRODUCT DESCRIPTION AND PRICING ERRORS</a>
                    <br />
                  ...
                  <p>
                    <a style={{fontWeight:'550'}}>22.	ELECTRONIC SIGNATURE AND NOTICE</a>
                    <br/>
                    <br/>
                    Customer understands that checking the box to agree to these Terms constitutes a legally binding electronic signature that has the same force and effect as a manual signature. Customer agrees that notices about an order or otherwise related to these Terms may be sent by email or other electronic communication. Customer acknowledges that these Terms and the Terms of Use (available at <a href={'http://www.mars.com/global/policies/legal/ld-english.aspx'} style={{textDecoration:'underline'}}>http://www.mars.com/global/policies/legal/ld-english.aspx</a>) will apply equally. If any provision of the Terms of Use and these Terms are irrevocably inconsistent, then the provision in these Terms will prevail to the extent of the inconsistency.
                    <br/>
                    Customers should direct Product concerns to ROYAL CANIN Customer Care at 1-844-673-3772 so that ROYAL CANIN may investigate and appropriately address such Product concerns.   <br/>
                    <br/>
                    For assistance with your order please call <a style={{textDecoration:'underline'}}>1-844-673-3772</a>. Orders can be placed online at <a style={{textDecoration:'underline'}} href='http://shop.royalcanin.com/us'>http://shop.royalcanin.com/us</a>   </p>
