          ...
          <div className='comme-chien-chat-box'>
            <div className='section'>
              <div className='section-content'>
                ...
                <div className='desc-1'>
                  Royal Canin réouvre dans le 3e arrondissement son Concept Store, un lieu unique en son genre pour vous, vos chiens et vos
                  chats. Un espace de découvertes sur votre animal et ses besoins, allant de la recommandation nutritionnelle à des
              ...
              <div className='section-content column-2'>
                <div className='section-content-item'>
                  ...
                  <div className='desc-2'>
                    "Vous connaissez votre animal sur le bout des doigts et pourtant, il n'est pas toujours évident de prendre soin de lui
                    au quotidien, de trouver les bons produits pour lui, les bons conseils et surtout le bon interlocuteur. <br/><br/>

                    Chez Comme Chien et Chat, laissez vous guider par nos conseillers, et découvrez tous les besoins spécifiques et
                    insoupçonnés de votre chat ou de votre chien, accompagnés des conseils, produits et services qui leur sont les plus
                    adaptés pour vivre en ville et ailleurs. <br/><br/>

                    Ici, vous rencontrez d'autres passionnés, des experts et des connaisseurs des chats et des chiens au travers de nos
                    événements, que nous avons imaginés spécialement pour vous. <br/><br/>

                    Car la santé et le bien-être de votre animal sont notre priorité, nous avions à cœur chez Royal Canin, de créer un lieu
                    avec tout ce dont vous avez besoin pour prendre soin de votre compagnon à 4 pattes. " <br/><br/>
                  </div>
              ...
              <div className='section-content column-2'>
                ...
                <div className='section-content-item content-justify-center'>
                  ...
                  <div className='desc-2 customized-desc'>
                    Venez découvrir notre approche nutritionnelle ainsi que l'étendue de notre gamme sous les conseils de notre équipe sur
                    place. Nous y proposons aussi un portefeuille d'accessoires divers pour le bien-être optimal de votre animal.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className='section'>
              <div className='section-content column-2'>
                <div className='section-content-item content-justify-center'>
                  <div className='title-2'>
                    Faites leurs plaisir !
                  </div>
                  <div className='desc-2'>
                    Profitez d'avantages exceptionnels en achetant dans notre Concept Store.
                  </div>
                </div>
                <div className='section-content-item'>
            ...
            <div className='section bg-gray'>
              <div className='section-content'>
                <div className="section-content-item content-align-center">
                  <div className='title-2'>Venez à la découverte de Royal Canin</div>
