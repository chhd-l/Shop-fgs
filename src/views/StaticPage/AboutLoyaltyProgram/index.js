        ...
        >
          <div className='m-auto hidden md:block'>
            <div className="mt-24 ">
              ...
              <p
                className=" h-64 PingFangSC text-primary-gray text-center text-18 font-normal leading-32 mt-16"
              >
          ...
          <div className='h-672 PingFangSC text-primary-gray text-center text-16 font-normal leading-24 mt-24.35 m-auto '>
            <p className='w-284'>マイ ロイヤルカナンのポイントプログラムは、1ポイント＝1円としてマイ ロイヤルカナンで使用できるポイントがご購入の度に貯まる、お得なプログラムです。ポイントの付与率は、マイ ロイヤルカナンでの直近6ヵ月間の製品購入累計金額＊によって決まる、３つのステージ（ブロンズ、シルバー、ゴールド）によって異なります。<br/>
