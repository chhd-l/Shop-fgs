                                ...
                                <div className="rc-column rc-double-width rc-padding-top--md--mobile text-center text-md-left rc-padding-right--none--desktop">
                                    <div>
                                        ...
                                        <div className="rc-margin-top--xs">
                                            <a className='rc-numeric nowrap' style={{ color: "#00A4A6" }} href={`tel:${this.props.configStore.storeContactPhoneNumber}`}>{this.props.configStore.storeContactPhoneNumber}</a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        ...
                                        <p>{`Vous pouvez également consulter notre rubrique `}
                                            <DistributeHubLinkOrATag
                                                style={{ color: 'rgb(236,0,26)', backgroundColor: 'rgb(255,255,255)', padding: '0 3px' }}
                                                to="/faq"
                                                href="/about-us/faqs"
