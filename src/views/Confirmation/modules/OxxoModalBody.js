      ...
      <div id="oxxoModalBody">
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              <FormattedMessage id="deposited48Hours" />
            </li>
            <li>
              <FormattedMessage id="mentionPagoService" />
            </li>
            <li>
              <FormattedMessage id="tellCashier" />
            </li>
          </ul>
          <div className="commission">
            <span className="firstSpan">
             <div className="circle"></div> <FormattedMessage id="oxxoCommission" />
            </span>
            <span>
            <div className="circle"></div><FormattedMessage id="maximumAmount" />
            </span>
          </div>
          ...
          <div className="barCode">
            <img src={testBarCode} alt="" />
            <div className="number">{this.state.oxxoAllNumber}</div>
            <div className="expirationPayment">
              <FormattedMessage id="expirationDate" />
            </div>
            <div className="expirationDate">
              <FormattedMessage id="before" /> 7 am. on July 11, 2020
            </div>
          </div>
            ...
            <div className="concept">
              ...
              <div style={{ padding: "0px 7%" }}>
                ...
                <div style={{ marginBottom: "20px" }}>
                  <div>
                    <FormattedMessage id="purchaseHomeOnline" />
                  </div>
                  <div>13062511</div>
                </div>
                <div style={{ marginBottom: "15px", fontWeight: 700 }}>
                  {formatMoney(this.state.amount)}
                </div>
                <div className="feeTip">
                  <FormattedMessage id="oxxoTransactionFee" />
                </div>
              </div>
            </div>
          </div>
