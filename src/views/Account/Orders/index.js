  ...
  async handleClickPayNow(order) {
    ...
    try {
      ...
      const tmpDeliveryAddress = {
        ...
        city: detailResCt.consignee.city == detailResCt.consignee.cityName ? null : detailResCt.consignee.city,
      ...
      const tmpBillingAddress = {
        ...
        city: detailResCt.invoice.city == detailResCt.invoice.cityName ? null : detailResCt.invoice.city,
