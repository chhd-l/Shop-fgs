  ...
  render () {
    ...
    return (
      <div className={`${this.props.visible ? '' : 'hidden'}`}>
        <div id={`J-address-title-${this.props.id}`} className="card-header" style={{ marginTop: this.props.type === 'billing' ? -56 : 0, overflow: 'hidden' }}>
        ...
        <div className={`rc-margin-bottom--sm ${!addOrEdit ? '' : 'checkout--padding'} ${loading ? 'pt-3 pb-3' : ''}`}>
          {
            loading
                        ...
                        ? <>
                          {
                            addressList.map((item, i) => (
                              <div
                                className={`address-item ${item.selected ? 'selected' : ''}`} key={item.deliveryAddressId}
                                ...
                                <div className="row align-items-center pt-3 pb-3 ml-2 mr-2">
                                  ...
                                  <div className="col-12 col-md-2 mt-md-0 mt-1 text-right">
                                    <a className="addr-btn-edit pr-2" onClick={() => this.addOrEditAddress(i)}>
                  ...
                  }
                  {
                    ...
                    <div className="text-right" style={{ marginTop: "10px" }}>
                      ...
                      <button
                        ...
                        onClick={() => {
                          this.props.save(addressList.filter((el) => el.selected)[0]);
                        }}
                      >
                        Save
                      </button>
