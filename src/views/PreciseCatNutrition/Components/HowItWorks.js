              ...
              <div className='rc-margin-top--md rc-margin-top--none--mobile rc-padding-x--lg--mobile'>
                ...
                {/*<div className="row rc-content-v-middle text-center rc-padding-top--md rc-margin-x--none">*/}
                    <div className="col-12 col-md-1 col-xxl-3 d-flex px-0 pl-md-0 pr-md-2  pr-xxl-3 pl-xxl-0 justify-content-center">
                      <div  style={{border:'2px solid #cccccc'}}  className=" centered-icon-list__icon justify-content-start justify-content-xxl-center align-items-center w-100 value-proposition__content flex Lpflexcolumn Lpflexrow">
                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                          <div style={{borderRadius: '50%',backgroundColor:'#E2001A',color:'white'}}>
                            1
                          </div>
                          <LazyLoad>
                            {/*<img*/}
                        ...
                        <div className='text-center'>
                          <a>
                            Tell us about your cat and help us shape the perfect recipe for him
                            {/*<FormattedMessage*/}
                    ...
                    <div className="col-12 col-md-1 col-xxl-3 d-flex px-0 pl-md-0 pr-md-2  pr-xxl-3 pl-xxl-0 justify-content-center" >
                      <div style={{border:'2px solid #cccccc'}} className=" centered-icon-list__icon justify-content-start justify-content-xxl-center align-items-center w-100 value-proposition__content flex Lpflexcolumn Lpflexrow">
                        ...
                        <div style={{height:72}} className='text-center'>
                          <h7>
                            Stay in control; pause. move
                            or skip your deliveries
                            {/*<FormattedMessage*/}
                            {/*  id="subscription.ad.list1"*/}
                            {/*  values={{*/}
                            {/*    val1: <br />,*/}
