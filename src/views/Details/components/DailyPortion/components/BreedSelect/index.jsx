...
export default function BreedSelect({
  ...
  useEffect(() => {
    const defaultValue = mixedBreedPossibleOptions.find(
      (item) => item.value === mixedBreedPossibleValue?.value
    );
    setInputMixedBreedPossibleValue(
  ...
  const handleSelectChange = (val) => {
    ...
    if (!!defaultValue) {
      ...
      setHiddenWaring(
        value?.nameInEnglish?.toLocaleUpperCase() ===
          defaultValue?.toLocaleUpperCase()
      );
    }
  };
  ...
  const handleSelectMixedBreedChange = (e) => {
    ...
    if (bool) {
      ...
      const defaultValue = options.find(
        (item) => item.localName === value?.name
      );
            ...
            <div>
              ...
              >
                ...
                <span className="text-sm lg:text-base">
                  {intl.formatMessage({ id: 'dailyPortion.breed.waring' })}
                </span>
              </p>
            </div>
          )}
