...
const ClubBuyMethod = ({
  ...
  return (
    ...
    <div
      className={`buyMethod club-buy-method d-flex row 3 ml-0 mr-0 justify-content-between ui-cursor-pointer-pure ${form.buyWay === 2?'border-solid border-b border-d7d7d7':''}`}
