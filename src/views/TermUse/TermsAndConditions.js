                    ...
                    <div className="rc-bg-colour--brand3 rc-bottom-spacing data-checkout-stage rc-max-width--lg rc-padding-x--md--mobile">
                        <div className="rc-bg-colour--brand3">
                            <div className="rc-padding--sm rc-padding-left--none">
                                ...
                                <p>
                                    <div>
                                        <span className="pr-3">4.2</span>Im Royal Canin Onlineshop stehen den Tierhalter*innen folgende Zahlungsarten zur Verfügung: <br />
                                        <div className="pl-5 mt-3">
                                ...
                                <div className="mb-2 dark bold"><span className="pr-3">5.</span>Eigentumsvorbehalt</div>
                                <p>
                                    <div>
                                        <span className="pr-4"></span>Bis zur vollständigen Bezahlung verbleiben die gelieferten Produkte im Eigentum von Royal Canin.
                                    </div>
                                </p>
                                <div className="mb-2 dark bold"><span className="pr-3">6.</span>Gewährleistung</div>
                                <p>
                                    <div>
                                        <span className="pr-3">6.1</span>Es gelten die gesetzlichen Vorschriften zur Gewährleistung.
                    </div>
                                </p>
                                <p>
                                    <div>
                                        <span className="pr-3">6.2</span>Im Falle eines Mangels werden Tierhalter*innen um Kontaktaufnahme unter [Tel.: 0221 937060 600 oder per Mail an: info.de@royalcanin.com] gebeten. Auf die gesetzlichen Ansprüche den Tierhalter*innen hat dies keine nachteiligen Auswirkungen. 
                    </div>
                                </p>
                                <div className="mb-2 dark bold"><span className="pr-3">7.</span>Haftung</div>
                                <p>
                                    <div>
                                        <span className="pr-3">7.1</span>Royal Canin haftet nicht dafür, dass die von der Tierärztin/vom Tierarzt gegebenen Fütterungsempfehlungen für die betreffenden Haustiere der Tierhalter*innen und ihre spezifischen Ernährungsbedürfnisse geeignet sind.
                    </div>
                                </p>
                                <p>
                                    <div>
                                        <span className="pr-3">7.2</span>Für Ansprüche aufgrund von Schäden, die durch Royal Canin, ihre gesetzlichen Vertreter oder Erfüllungsgehilfen verursacht wurden, haftet Royal Canin stets im gesetzlichen Umfang
                                        <div className="pl-5 mt-3">
                                ...
                                <p>
                                    <div>
                                        <span className="pr-3">7.3</span>Bei Verletzung wesentlicher Vertragspflichten, deren Erfüllung die ordnungsgemäße Durchführung des Vertrages überhaupt erst ermöglicht und auf deren Einhaltung der Vertragspartner regelmäßig vertrauen darf (sog. Kardinalpflichten) durch leichte Fahrlässigkeit von Royal Canin, ihrer gesetzlichen Vertreter oder Erfüllungsgehilfen, ist die Haftung der Höhe nach auf den bei Vertragsschluss vorhersehbaren Schaden begrenzt, mit dessen Entstehung typischerweise gerechnet werden muss.
                                    </div>
                                </p>
                                <p>
                                    <div>
                                        <span className="pr-3">7.4</span>Im Übrigen sind Ansprüche auf Schadensersatz ausgeschlossen.
                                    </div>
                                </p>
                                <div className="mb-2 dark bold"><span className="pr-3">8.</span>Widerrufsrecht</div>
                                <p>
                                    <div>
                                        <span className="pr-3">8.1</span>Tierhalter*innen steht ein Widerrufsrecht zu.
                                    </div>
                                </p>
                                <p>
                                    <div>
                                ...
                                <p>
                                    ...
                                    <div className="pl-5 mt-3">
                                        - An ROYAL CANIN Tiernahrung GmbH & Co. KG, Habsburgerring 2, 50674 Köln<br/>
                                ...
                                <p>
                                    <div>
                                        <div className="mb-1">
                                            <span className="pr-3">8.4</span>Kein Widerrufsrecht<br/>
                                        </div> 
                                        <span className="pr-4 ml-3"></span>Das Widerrufsrecht besteht nicht bei folgenden Verträgen:<br/>
                                        <div className="pl-5 mt-3">
                                ...
                                <div className="mb-2 dark bold"><span className="pr-3">9.</span>Online-Streitbeilegung</div>
                                <p>
                                    <div>
                                        <span className="pr-3">9.1</span>Royal Canin nimmt nicht am Verfahren zur alternativen Streitbeilegung in Verbrauchersachen gemäß § 36 VSBG teil.
                                    </div>
                                </p>
                                <p>
                                    <div>
                                        <span className="pr-3">9.2</span>Hinweis zur Online-Streitbeilegung gemäß Art. 14 Abs. 1 ODR-VO: Die Europäische Kommission stellt unter <a className="rc-styled-link" href="http://ec.europa.eu/consumers/odr/">http://ec.europa.eu/consumers/odr/</a> eine Plattform zur Online-Streitbeilegung (OS) bereit. Royal Canin ist nicht bereit oder verpflichtet, an einem Streitbeilegungsverfahren teilzunehmen.
                                    </div>
                                </p>
                                <div className="mb-2 dark bold"><span className="pr-3">10.</span>Schlussbestimmungen</div>
                                <p>
                                    <div>
                                        <span className="pr-3">10.1</span>Es findet das Recht der Bundesrepublik Deutschland unter Ausschluss des UN-Kaufrechts Anwendung. Diese Rechtswahl gilt nur insoweit, als nicht der durch zwingende Bestimmungen des Rechts des Staates, in dem die Tierhalter*innen ihren gewöhnlichen Aufenthalt haben, gewährte Schutz entzogen wird.
                                    </div>
                                </p>
                                <p>
                                    <div>
                                        <span className="pr-3">10.2</span>Sollten einzelne Bestimmungen dieser Nutzungsbedingungen ganz oder teilweise nichtig oder unwirksam sein oder werden, so wird dadurch die Wirksamkeit der übrigen Bestimmungen nicht berührt.
                                    </div>
                                </p>
                            </div>
                        </div>
