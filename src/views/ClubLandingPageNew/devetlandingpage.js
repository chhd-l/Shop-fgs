            ...
            <div className="rc-bg-colour--brand3 rc-margin-bottom--xs">
              <div className="rc-max-width--xl rc-padding-x--sm rc-padding-x--md--mobile category-cards rc-padding--sm">
                <div className=" rc-match-heights text-center text-md-left">
                  <div className="DeCenter col-lg-3 align-self-center"><h2
                    className="rc-beta rc-margin--none rc-padding--xs rc-padding--lg--mobile text-center rc-padding-top--none">Unsere Produkte für verschiedene Schwerpunkte der Tiergesundheit</h2></div>
                  <div className="DeCenter col-lg-9">
                    <div className="row custom-gutter"><span
                      className="hidden rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"></span>
                      <div className="col-6 col-md-3"><a
                        ...
                        title="Aufzucht &amp; Wachstum" href="/de/aufzucht_wachstum">
                        <picture className="category-cards__card__img">

                            <div className="lazyload-wrapper ">
                              <img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250505313217.jpg"
                              alt="Aufzucht &amp; Wachstum product image" style={{width:'144px'}}/>
                            </div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Aufzucht &amp; Wachstum</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Diabetes mellitus" href="/de/diabetes_mellitus">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250443423647.jpg"
                              alt="Diabetes mellitus product image" style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Diabetes mellitus</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Gelenke" href="/de/gelenke">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250449533854.jpg" alt="Gelenke product image"
                              style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Gelenke</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Haut &amp; Fell" href="/de/haut_fell">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250439243509.jpg"
                              alt="Haut &amp; Fell product image" style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Haut &amp; Fell</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Herz" href="/de/herz">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250452557607.jpg" alt="Herz product image"
                              style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Herz</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Kastration" href="/de/kastration">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250459262693.jpg" alt="Kastration product image"
                              style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Kastration</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Leber" href="/de/leber">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250447457709.jpg" alt="Leber product image"
                              style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Leber</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Magen-Darm-Trakt" href="/de/magen_darm_trakt">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250445143898.jpg"
                              alt="Magen-Darm-Trakt product image" style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Magen-Darm-Trakt</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Maulhöhle" href="/de/maulhohle">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250502527142.jpg" alt="Maulhöhle product image"
                              style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Maulhöhle</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Niere" href="/de/niere">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250448519699.jpg" alt="Niere product image"
                              style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Niere</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Pill Assist" href="/de/pill_assist">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250507286476.jpg" alt="Pill Assist product image"
                              stylestyle={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Pill Assist</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Prophylaxe" href="/de/prophylaxe">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250506536953.jpg" alt="Prophylaxe product image"
                              style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Prophylaxe</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Übergewicht" href="/de/ubergewicht">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250442139814.jpg" alt="Übergewicht product image"
                              style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Übergewicht</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Untere Harnwege" href="/de/untere_harnwege">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250435180570.jpg"
                              alt="Untere Harnwege product image" style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Untere Harnwege</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Verhalten" href="/de/verhalten">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202011250504018221.jpg" alt="Verhalten product image"
                              style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Verhalten</h3></div>
                      </a></div>
                      <div className="col-6 col-md-3"><a
                        className="rc-card rc-card--a rc-margin-bottom--xs--mobile category-cards__card fullHeight gtm-cat-link"
                        title="Alles anzeigen" href="/de/list/keywords">
                        <picture className="category-cards__card__img">
                            <div className="lazyload-wrapper "><img
                              src="https://d2cstgstorage.z13.web.core.windows.net/202012140704238285.jpg" alt="Alles anzeigen product image"
                              title="all" style={{width:'144px'}}/></div>
                        </picture>
                        <div
                          className="rc-text--center rc-intro category-cards__card__text rc-margin--none inherit-fontsize rc-padding-x--xs">
                          <h3 className="rc-margin--none">Alles anzeigen</h3></div>
                      </a></div>
                    </div>
                  </div>
                </div>
