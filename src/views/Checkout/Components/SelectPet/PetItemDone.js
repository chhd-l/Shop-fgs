...
const PetItemDone = ({ item, className, idx, paymentStoreNew }) => {
  const { petList, petSelectedIds } = paymentStoreNew;
  return (
...
export default inject('paymentStoreNew')(observer(PetItemDone));
