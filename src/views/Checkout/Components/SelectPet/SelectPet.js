...
const SelectPet = ({ checkoutStore, loginStore, paymentStoreNew, isRepay }) => {
  const { isLogin } = loginStore;
  const { isShowBindPet, cartData, loginCartData } = checkoutStore;
  const { bindPetPanelStatus, setPetSelectedIds } = paymentStoreNew;
  usePetLists({ loginStore, paymentStoreNew });
